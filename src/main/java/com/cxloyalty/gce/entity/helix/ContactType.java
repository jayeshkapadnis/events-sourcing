...
public class ContactType implements Serializable {
    ...
    @Id
    @Column(name="contact_type_id", nullable=false, precision=9)
    private BigDecimal contactTypeId;
    @Column(name="contact_type_desc", nullable=false, length=100)
     ...
     */
    public void setContactTypeId(BigDecimal aContactTypeId) {

...
@Entity(name="stage_membership")
public class StageMembership implements Serializable {

    /** Primary key. */
    protected static final String PK = "membershipId";
    ...
    @Id
    @Column(name="membership_id", unique=true, nullable=false, precision=19)
    ...
    @OneToMany(mappedBy="stageMembership")
    private Set<StageProtectedCard> stageProtectedCard;

    /** Default constructor. */
    public StageMembership() {
        super();
    }
    ...
    /**
     * Compares the key for this instance with another StageMembership.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class StageMembership and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof StageMembership)) {
            return false;
        }
        StageMembership that = (StageMembership) other;
        if (this.getMembershipId() != that.getMembershipId()) {
            return false;
        }
        return true;
    }
    ...
    /**
     * Compares this instance with another StageMembership.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof StageMembership)) return false;
        return this.equalKeys(other) && ((StageMembership)other).equalKeys(this);
    }
    ...
    public int hashCode() {
        int i;
        int result = 17;
        i = (int)(getMembershipId() ^ (getMembershipId()>>>32));
        result = 37*result + i;
        return result;
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[StageMembership |");
    ...
    public Map<String, Object> getPrimaryKey() {
        ...
        ret.put("membershipId", Long.valueOf(getMembershipId()));
        return ret;
    }
